...
public class LogConverterTest
{
    ...
    public async Task ConvertToArchivedProjectLog_Test()
    {
        var log = new Log
        {
            ...
            User = new User { UserName = "Deep Thought" },
            ProjectId = 44,
            Project = new Project
            {
    ...
    public async Task ConvertToAddedProjectLog_Test()
    {
        var log = new Log
        {
            ...
            User = new User { UserName = "Infinite Improbability Drive" },
            ProjectId = 45,
            Project = new Project
            {
    ...
    public async Task ConvertToRemovedProjectPluginLog_Test()
    {
        var log = new Log
        {
            ...
            User = new User { UserName = "Prostetnic Vogon Jeltz" },
            ProjectId = 47,
            Project = new Project
            {
