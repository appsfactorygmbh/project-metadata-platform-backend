...
/// <param name="BaseUrl">The plugin's new base url.</param>
/// <returns>A Plugin object that represents the updated plugin.</returns>
public record PatchGlobalPluginCommand(int Id, string? PluginName = null, bool? IsArchived = null, string? BaseUrl = null): IRequest<Plugin>;