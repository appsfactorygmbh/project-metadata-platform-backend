...
public record CreateProjectRequest(string ProjectName, string BusinessUnit, int TeamNumber, string Department, string ClientName, List<UpdateProjectPluginRequest>? PluginList = null, bool? isArchived = false);
