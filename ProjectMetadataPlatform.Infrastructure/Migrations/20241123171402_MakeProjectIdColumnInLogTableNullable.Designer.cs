...
namespace ProjectMetadataPlatform.Infrastructure.Migrations
{
    ...
    [Migration("20241123171402_MakeProjectIdColumnInLogTableNullable")]
    partial class MakeProjectIdColumnInLogTableNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectMetadataPlatform.Domain.Logs.Log", b =>
                {
                    b.HasOne("ProjectMetadataPlatform.Domain.User.User", "AffectedUser")
                        .WithMany()
                        .HasForeignKey("AffectedUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("ProjectMetadataPlatform.Domain.User.User", "Author")
                        .WithMany()
